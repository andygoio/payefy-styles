(function() {
  ...
  function addPayefyCardGraphics() {
    ...
    // Contenedor para Chip y Contactless (arriba izquierda) - posición: top: 55px, left: 28px, gap: 12px
    ...
    contactless.style.cssText = 'width: 28px; height: 28px; flex-shrink: 0; display: block; visibility: visible; opacity: 1;';
  ...
  function adjustCardContentPositions() {
    ...
    allRows.forEach(function(row) {
      ...
      if (panField) {
        // PAN va en la parte inferior, alineado a la izquierda con el chip (left: 28px)
